  ...
  return (
    <div className={style.content}>
      ...
      <Fade>
        ...
        <p>Enjoying the producing projects; open to new challenges and collaborations to bring ideas to life and creating new connections; producing results with the customers needs in mind.</p>
